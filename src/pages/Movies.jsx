      ...
      <div className="row mb-4">
        <div className="col-md-6 mb-3">
          ...
          <div className="btn-group w-100" role="group">
            ...
            />
            <label className="btn btn-outline-primary" htmlFor="now-showing">
            ...
            />
            <label className="btn btn-outline-primary" htmlFor="coming-soon">
      ...
      <div className="row mb-4">
        ...
        <div className="col-md-6 mb-3">
          ...
          <div className="d-flex flex-wrap gap-2">
            <button
              className={`btn btn-sm ${genreFilter === 'all' ? 'btn-primary' : 'btn-outline-primary'}`}
            ...
            {allGenres.map(genre => (
              <button
                key={genre}
                className={`btn btn-sm ${genreFilter === genre ? 'btn-primary' : 'btn-outline-primary'}`}
