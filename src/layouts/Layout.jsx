...
const Layout = () => {
    ...
    return (
        <div className='min-vh-100 d-flex flex-column'>
            ...
            {/* Main Content */}
            <main className='flex-grow-1' style={{ paddingTop: '35px' }}>
                <Outlet />
            </main>
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-3 mb-3'>
                            ...
                            <p className='small'>
                                Hệ thống rạp chiếu phim hiện đại, mang đến trải
                        ...
                        <div className='col-md-3 mb-3'>
                            <h6 className='fw-bold'>Điều khoản sử dụng</h6>
                            <ul className='list-unstyled small'>
                                <li>
                                    <Link
                                        to='#'
                        ...
                        <div className='col-md-3 mb-3'>
                            ...
                            <ul className='list-unstyled small'>
                                ...
                                <li>
                                    ...
                                    Giờ làm việc: 8:00 - 23:00 (Tất cả các ngày
                                    bao gồm cả Lễ Tết)
                                </li>
                                <li>
                    ...
                    <div className='text-center small'>
                        <p className='mb-0'>
                            &copy; 2026 CGV Cinemas by Mai Anh Tuấn Anh. All
                            rights reserved.
                        </p>
                    </div>
                </div>
